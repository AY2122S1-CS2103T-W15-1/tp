...
Let’s start by creating a new `RemarkCommand` class in the `src/main/java/classmate/logic/command` directory.
...
Simply add the following to [`classmate.ui.StudentCard`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-0c6b6abcfac8c205e075294f25e851fe).
